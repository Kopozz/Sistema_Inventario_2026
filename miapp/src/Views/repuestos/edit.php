...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-edit me-2"></i>Editar Repuesto</h2>
                ...
                <form method="POST" action="<?= BASE_URL ?>repuestos/<?= $repuesto->getId() ?>" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="codigo" name="codigo" 
                                       value="<?= htmlspecialchars($repuesto->getCodigo()) ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="categoria_id" name="categoria_id" required>
                                    ...
                                    <option value="<?= $categoria->getId() ?>" 
                                            <?= ($repuesto->getCategoriaId() == $categoria->getId()) ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" 
                               value="<?= htmlspecialchars($repuesto->getNombre()) ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descripcion" name="descripcion" rows="3"><?= htmlspecialchars($repuesto->getDescripcion()) ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="precio_compra" name="precio_compra" 
                                           value="<?= $repuesto->getPrecioCompra() ?>" 
                                ...
                                <?php if ($repuesto->getImagen()): ?>
                                    <div class="mb-3">
                                        ...
                                        <div style="width:160px; height:160px; background:#111; border-radius:10px; overflow:hidden; display:flex; align-items:center; justify-content:center;">
                                            <img src="<?= $imgUrl ?>" alt="Imagen actual" style="max-width:100%; max-height:160px; object-fit:contain; display:block;">
                                        </div>
                                        <div class="form-text text-warning mt-1"><i class="fas fa-info-circle me-1"></i>Subir una nueva imagen reemplazará la anterior.</div>
                                    </div>
                                <?php endif; ?>
    ...
    reader.onload = function(event) {
        ...
        img.onload = function() {
            ...
            document.getElementById('img_info').innerHTML =
                ...
                <strong>Nueva imagen procesada</strong><br>
