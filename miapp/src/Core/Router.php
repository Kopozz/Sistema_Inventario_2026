...
class Router {
    ...
    $this->addRoute('GET', '/index.php', 'HomeController@index');
        ...
        $this->addRoute('GET', '/repuestos/stock-bajo', 'RepuestoController@stockBajo');
    ...
    $this->addRoute('POST', '/ventas/{id}/anular', 'VentaController@anular');
        ...
        $this->addRoute('GET', '/reportes/exportar-ventas', 'ReporteController@exportarVentas');
        $this->addRoute('GET', '/reportes/exportar-stock', 'ReporteController@exportarStock');
        $this->addRoute('GET', '/reportes/exportar-movimientos', 'ReporteController@exportarMovimientos');
    }
